...
import { FieldErrors, UseFormRegister, Control, UseFormSetValue } from "react-hook-form";
...
export const signUpSchema = z
  .object({
    ...
    address: z.object({
      alias: z.string().min(1, "Apelido de endereço é obrigatório"),
      zip_code: z.string().min(8, "CEP inválido"),
      state: z.string().min(2, "Estado obrigatório"),
      city: z.string().min(2, "Cidade obrigatória"),
      neighborhood: z.string().min(2, "Bairro obrigatório"),
      road: z.string().min(2, "Logradouro obrigatório"),
